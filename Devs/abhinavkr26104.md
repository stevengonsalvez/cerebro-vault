...
provenance:
  - "73468cde177ddae6"
pushes_per_week: [28, 48, 16, 31, 10, 3, 0, 8, 2, 5, 1, 0, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  ...
  - name: "ReconPilot"
    title: "ReconPilot"
    description: "Exception-first settlement reconciliation for Razorpay merchants"
    language: "Python"
    topics: []
    stars_fact: 0
    first_seen: null
  ...
  - name: "agent-index"
    title: "agent-index"
    description: "A CLI that turns any codebase into structured, persistent context for AI coding agents."
    language: "TypeScript"
    topics: []
    stars_fact: 0
    first_seen: null
  ...
  - name: "GeekForGeeks_me"
    title: "GeekForGeeks_me"
...
152 pushes across 11 repositories on 29 active days in the last 90 days of public GitHub push activity.
