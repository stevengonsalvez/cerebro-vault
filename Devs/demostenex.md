...
provenance:
  - "4138778ebbc75ba6"
pushes_per_week: [0, 0, 0, 4, 0, 0, 0, 0, 1, 1, 0, 5, 2]
windows:
  "7d":
    pushes: 2
    distinct_repos: 2
...
repos:
  ...
  - name: "polybar-calendar-kikito"
    title: "polybar-calendar-kikito"
    description: "Um calendario em yad mais python que sincroniza com o google api"
    language: "Python"
    topics: []
    stars_fact: 0
    first_seen: null
  ...
  - name: "xdir"
    title: "xdir"
    description: "Gerenciador gráfico de arquivos para Linux/X11 em Rust — keyboard-first, layout parent/current/preview, tiling interno."
    language: "Rust"
    topics: []
    stars_fact: 0
    first_seen: null
