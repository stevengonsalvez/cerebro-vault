...
provenance:
  - "745308b2b7085095"
pushes_per_week: [19, 2, 13, 6, 11, 9, 2, 10, 3, 10, 4, 6, 2]
windows:
  "7d":
    pushes: 2
    distinct_repos: 2
...
repos:
  ...
  - name: "zotero-skills"
    title: "zotero-skills"
    description: "A skill for managing Zotero references programmatically — search, add, classify, annotate, and organize literature."
    language: "Python"
    topics: []
    stars_fact: 52
    first_seen: null
...
97 pushes across 13 repositories on 43 active days in the last 90 days of public GitHub push activity.
