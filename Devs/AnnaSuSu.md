...
provenance:
  - "16389f32495280ea"
  - "dffbb846389f9a26"
pushes_per_week: [3, 0, 4, 3, 0, 3, 3, 0, 1, 8, 3, 3, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  - name: "TechSpar"
    title: "TechSpar"
    description: "一个持续进化的面试训练系统。在线体验地址：https://techspar.cn"
    language: "TypeScript"
    topics:
      - "ai-interview"
      - "interview-coaching"
  ...
  - name: "arxiv-mcp"
    title: "arxiv-mcp"
    description: "MCP server for searching and reading arXiv papers with LLMs"
    language: "Python"
    topics:
      - "arxiv"
      - "llm"
...
31 pushes across 9 repositories on 18 active days in the last 90 days of public GitHub push activity.
