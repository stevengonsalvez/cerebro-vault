...
provenance:
  - "b1a4604cc570de42"
pushes_per_week: [20, 27, 22, 5, 0, 0, 1, 0, 1, 0, 0, 0, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  ...
  - name: "fflip"
    ...
    stars_fact: 649
    first_seen: null
    last_push: "2020-09-15"
  - name: "esm-hmr"
    title: "esm-hmr"
    description: "a Hot Module Replacement (HMR) API for your ESM-based dev server."
    language: "TypeScript"
    topics:
      - "esm-hmr"
      - "hmr-server-engine"
    ...
    stars_fact: 432
    first_seen: null
    last_push: "2024-06-17"
  - name: "rollup-plugin-polyfill-node"
    title: "rollup-plugin-polyfill-node"
    description: "A modern Node.js polyfill for your Rollup bundle."
    language: "TypeScript"
    topics: []
    stars_fact: 193
    first_seen: null
    last_push: "2024-05-27"
---

# FredKSchott

76 pushes across 3 repositories on 26 active days in the last 90 days of public GitHub push activity.
