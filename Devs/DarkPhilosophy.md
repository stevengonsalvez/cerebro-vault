...
provenance:
  - "de6bf05613f3ae04"
pushes_per_week: [31, 43, 21, 11, 11, 21, 16, 6, 0, 0, 0, 11, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  ...
  - name: "omp-discord"
    title: "omp-discord"
    description: "󰙯 Explicit, local Discord account operations for Oh My Pi — scoped tools, persistent channel follow as a background job, safe attachments, YAML config"
    language: "TypeScript"
    topics:
      - "agent-tools"
      - "bun"
...
171 pushes across 7 repositories on 45 active days in the last 90 days of public GitHub push activity.
