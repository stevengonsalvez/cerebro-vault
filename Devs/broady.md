...
provenance:
  - "4a45ac7a449df20e"
pushes_per_week: [3, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 4]
windows:
  "7d":
    pushes: 4
    distinct_repos: 1
...
repos:
  - name: "nix-devin-cli"
    title: "nix-devin-cli"
    description: "Devin CLI packaged for Nix, with nightly auto-updates"
    language: "Shell"
    topics:
      - "devin"
      - "nix"
  ...
  - name: "ghfs"
    title: "ghfs"
    description: "FUSE Filesystem for the GitHub API"
    language: "Go"
    topics: []
    stars_fact: 3
    first_seen: null
  ...
  - name: "gradleplease"
    title: "gradleplease"
    description: "Find the correct dependency string."
    language: "JavaScript"
    topics: []
    stars_fact: 33
    first_seen: null
