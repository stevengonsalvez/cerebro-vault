...
provenance:
  - "78a5846a75cc0fbb"
pushes_per_week: [14, 17, 13, 31, 0, 27, 1, 1, 0, 7, 0, 0, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  - name: "Cloudflare-Dashboard"
    ...
    description: "开源、自托管、凭据零上链的 Cloudflare 管理面板。"
    language: "Vue"
    topics: []
    stars_fact: 4
    first_seen: null
  ...
  - name: "astrbot_plugin_nai_brush"
    title: "astrbot_plugin_nai_brush"
    description: null
    language: "Python"
    topics: []
    stars_fact: 4
  ...
  - name: "astrbot_plugin_newapi_model_status"
    title: "astrbot_plugin_newapi_model_status"
    description: null
    language: "Python"
    topics: []
    stars_fact: 1
...
111 pushes across 18 repositories on 25 active days in the last 90 days of public GitHub push activity.
