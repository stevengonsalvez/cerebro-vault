...
provenance:
  - "dae9f02535f7c22f"
pushes_per_week: [18, 5, 9, 3, 2, 0, 3, 0, 2, 6, 0, 0, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  ...
  - name: "proton-mail-bridge-client"
    ...
    description: "🌉 Local-first Proton Mail MCP and CLI through Proton Bridge. Search, read, draft, send, sync, and act on mail from Claude Desktop or Terminal."
    language: "TypeScript"
    topics:
      - "claude"
      - "claude-code"
...
48 pushes across 9 repositories on 18 active days in the last 90 days of public GitHub push activity.
