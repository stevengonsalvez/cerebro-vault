...
provenance:
  - "4a45ac7a449df20e"
pushes_per_week: [1, 3, 1, 3, 4, 0, 0, 4, 0, 0, 0, 0, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  ...
  - name: "bibtexcite.vim"
    title: "bibtexcite.vim"
    description: "Bib(la)tex citations for vim"
    language: "Vim Script"
    topics: []
    stars_fact: 16
    first_seen: null
    last_push: "2024-10-16"
  - name: "throttlecmd"
    title: "throttlecmd"
    description: "Throttle commands triggered from multiple sources."
    language: "Go"
    topics: []
    stars_fact: 0
    first_seen: null
