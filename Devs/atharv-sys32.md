...
provenance:
  - "c489e6fb5febf2ab"
pushes_per_week: [1, 0, 0, 10, 31, 2, 1, 4, 0, 0, 0, 0, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  - name: "mui-aria-hidden-repro"
    title: "mui-aria-hidden-repro"
    description: "MUI Dialog aria-hidden repro: container change while open leaves stale aria-hidden on previous sibling"
    language: "JavaScript"
    topics: []
    stars_fact: 0
    first_seen: null
