...
provenance:
  - "de6bf05613f3ae04"
pushes_per_week: [0, 0, 0, 0, 0, 0, 0, 0, 1, 3, 6, 5, 2]
windows:
  "7d":
    pushes: 2
    distinct_repos: 2
...
repos:
  ...
  - name: "hermes-trace"
    ...
    first_seen: null
    last_push: "2026-09-01"
  - name: "hermes-optmem-tools"
    title: "hermes-optmem-tools"
    description: "OptMem as Hermes Agent tools — persistent agent memory without shell access"
    language: "Python"
    topics:
      - "agent-memory"
      - "ai-agents"
