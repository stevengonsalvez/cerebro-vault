...
provenance:
  - "6d3bd03b49986330"
pushes_per_week: [19, 12, 4, 4, 0, 1, 0, 0, 0, 0, 0, 0, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  ...
  - name: "cowSolver"
    title: "cowSolver"
    description: "Cross-chain CoW Protocol solver — automated settlement optimization with bridge integration"
    language: "Rust"
    topics:
      - "blockchain"
      - "cow-protocol"
  ...
  - name: "solidity-examples"
    ...
    description: "Solidity tutorials and sample contracts — learning reference covering patterns and DeFi primitives."
    language: "JavaScript"
    topics:
      - "ethereum"
      - "examples"
  ...
  - name: "titular"
    title: "titular"
    description: "Multi-chain commerce layer for AI agents — Base/Eth/Solana launchpad with ACP v2 + GAME planner."
    language: "Solidity"
    topics:
      - "acp"
      - "ai-agents"
...
40 pushes across 5 repositories on 13 active days in the last 90 days of public GitHub push activity.
