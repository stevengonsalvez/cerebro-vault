...
provenance:
  - "73468cde177ddae6"
pushes_per_week: [1, 4, 10, 1, 0, 1, 0, 0, 0, 2, 0, 0, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  - name: "locus-signal"
    title: "locus-signal"
    description: "Weekly customer risk & opportunity brief for a CRO — self-healing news query vocabulary"
    language: "TypeScript"
    topics: []
    stars_fact: 1
    first_seen: null
