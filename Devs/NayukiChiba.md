...
provenance:
  - "78a5846a75cc0fbb"
pushes_per_week: [10, 4, 5, 5, 3, 5, 0, 0, 1, 0, 0, 0, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  ...
  - name: "NayukiBlog"
    ...
    first_seen: null
    last_push: "2026-09-03"
  - name: "astrbot_plugin_arxiv"
    title: "astrbot_plugin_arxiv"
    description: "可以获取arXiv中的论文，每日定时推送，选择不同领域"
    language: "Python"
    topics: []
    stars_fact: 11
    first_seen: null
  ...
  - name: "lftp"
    title: "lftp"
    description: "Learning Theory from First Principles"
    language: "TeX"
    topics: []
    stars_fact: 1
    first_seen: null
...
33 pushes across 7 repositories on 18 active days in the last 90 days of public GitHub push activity.
