...
provenance:
  - "c489e6fb5febf2ab"
pushes_per_week: [0, 2, 2, 7, 13, 1, 2, 3, 2, 1, 1, 0, 1]
windows:
  "7d":
    pushes: 1
    distinct_repos: 1
...
repos:
  ...
  - name: "multi-agent-article"
    title: "multi-agent-article"
    description: "multi-agent-article"
    language: "HTML"
    topics: []
    stars_fact: 0
    first_seen: null
  ...
  - name: "xiaohei-workflow"
    title: "xiaohei-workflow"
    description: "基于小黑skill开发的IP形象工作台"
    language: "HTML"
    topics: []
    stars_fact: 15
    first_seen: null
  ...
  - name: "grok-obsidian"
    title: "grok-obsidian"
    description: "Use your Grok Build agent in Obsidian"
    language: "JavaScript"
    topics: []
    stars_fact: 8
    first_seen: null
...
35 pushes across 14 repositories on 16 active days in the last 90 days of public GitHub push activity.
