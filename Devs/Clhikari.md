...
provenance:
  - "78a5846a75cc0fbb"
pushes_per_week: [1, 0, 1, 0, 0, 1, 0, 1, 0, 0, 1, 0, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  ...
  - name: "Mosoteach"
    title: "Mosoteach"
    description: "一个为云班课 (Mosoteach) 设计的高性能、AI 驱动的自动化工具，拥有专业仪表盘界面，提供直观的控制和实时监控。"
    language: "Go"
    topics: []
    stars_fact: 0
    first_seen: null
  ...
  - name: "RealESRGAN_GUI"
    title: "RealESRGAN_GUI"
    description: "一个简易的Real-ESRGAN GUI工具,可放大小数级倍数"
    language: "Python"
    topics: []
    stars_fact: 2
    first_seen: null
    last_push: "2026-01-01"
  - name: "palm-netlify-proxy-ee673"
    title: "palm-netlify-proxy-ee673"
    description: null
    language: "TypeScript"
    topics: []
    stars_fact: 0
