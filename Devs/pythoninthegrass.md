...
provenance:
  - "73468cde177ddae6"
pushes_per_week: [2, 6, 2, 9, 2, 0, 1, 1, 3, 3, 1, 1, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  ...
  - name: "git_auto_pull"
    title: "git_auto_pull"
    description: "Fast forward all git repos on a schedule"
    language: "Shell"
    topics: []
    stars_fact: 1
    first_seen: null
  ...
  - name: "mcp-retroarch"
    title: "mcp-retroarch"
    description: "MCP server for RetroArch — memory r/w, save state, screenshot, pause/frameadvance/reset via NCI, plus gamepad input via Network RetroPad (UDP)"
    language: "Python"
    topics: []
    stars_fact: 0
    first_seen: null
