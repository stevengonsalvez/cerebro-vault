...
provenance:
  - "90688bf127241ceb"
pushes_per_week: [1, 5, 3, 1, 2, 1, 0, 1, 0, 0, 0, 0, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  ...
  - name: "FastWords"
    title: "FastWords"
    description: "Native macOS menu bar vocabulary app with local word books."
    language: "Swift"
    topics: []
    stars_fact: 1
    first_seen: null
  ...
  - name: "postbridge-lite-react"
    title: "postbridge-lite-react"
    description: null
    language: "JavaScript"
    topics: []
    stars_fact: 0
