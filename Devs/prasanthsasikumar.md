...
repos:
  - name: "PromptInvoice"
    title: "PromptInvoice"
    description: "Free invoice generator with AI drafting and team workspaces. Static site, no build step."
    language: "JavaScript"
    topics:
      - "claude"
      - "invoice"
  ...
  - name: "hermes-glasses"
    title: "hermes-glasses"
    description: "Voice + vision AI assistant for smart glasses — Meta Ray-Ban and AiSee / Realtek-based glasses: live on-device transcription, glasses camera capture, button mapping, and an optional Hermes Agent bridge."
    language: "Swift"
    topics:
      - "computer-vision"
      - "ios"
