...
provenance:
  - "3c90af76cbde0363"
pushes_per_week: [12, 10, 6, 8, 4, 4, 2, 0, 2, 2, 1, 0, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  ...
  - name: "moltbook-mcp"
    title: "moltbook-mcp"
    description: "MCP server for Moltbook - the social network for AI agents 🦞"
    language: "JavaScript"
    topics: []
    stars_fact: 4
    first_seen: null
  ...
  - name: "momentum-backtest"
    ...
    description: "Honest crypto momentum/scalping backtester. Proves with real data + cost decomposition why retail scalping loses after fees. Python, no API key."
    language: "Python"
    topics:
      - "backtesting"
      - "crypto"
...
51 pushes across 18 repositories on 30 active days in the last 90 days of public GitHub push activity.
