...
provenance:
  - "90688bf127241ceb"
pushes_per_week: [0, 0, 0, 0, 5, 0, 1, 0, 0, 0, 0, 1, 1]
windows:
  "7d":
    pushes: 2
    distinct_repos: 2
...
repos:
  ...
  - name: "ai-driven-develop-skills"
    title: "ai-driven-develop-skills"
    description: "让 Claude Code 像一支纪律严明的工程团队，从需求到部署分步推进、每步验收，可靠交付完整项目。"
    language: null
    topics: []
    stars_fact: 2
    first_seen: null
