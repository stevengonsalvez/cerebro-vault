...
provenance:
  - "dae9f02535f7c22f"
pushes_per_week: [1, 0, 0, 1, 4, 0, 0, 0, 0, 1, 0, 0, 0]
windows:
  "7d":
    pushes: 0
    distinct_repos: 0
...
repos:
  - name: "env-ubuntu"
    title: "env-ubuntu"
    description: "badly named repo with stuff i setup on my computers"
    language: "Shell"
    topics:
      - "bash"
      - "dotfiles"
  ...
  - name: "glimps-frontend"
    title: "glimps-frontend"
    description: "Glimps frontend - Vite React TypeScript SPA"
    language: "TypeScript"
    topics:
      - "glimps"
    stars_fact: 0
  ...
  - name: "glimps-infra"
    title: "glimps-infra"
    description: "Infrastructure: Docker Compose, PostgreSQL, Redis"
    language: null
    topics:
      - "glimps"
    stars_fact: 0
  ...
  - name: "opencode-harness"
    ...
    description: "Working Opencode from the ground up"
    language: "Shell"
    topics: []
    stars_fact: 0
    first_seen: null
